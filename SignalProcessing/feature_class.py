# From https://c4science.ch/diffusion/10770/browse/master/src/feature_class.py
...
class features:
    ...
    def spectral_features(self, data):
        names = ["Spectral_Centroid", "Spectral_Rolloff", "Spectral_Spread", "Spectral_Skewness", "Spectral_Kurtosis",
                 "Spectral_Bandwidth"]
        fs, x = data
